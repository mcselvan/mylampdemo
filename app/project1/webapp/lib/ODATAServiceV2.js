sap.ui.define(["sap/ui/base/Object",
	...
	return Object.extend("cap.project1.lib.ManageBusinessLogic", {
		...
		oCallReadDeferred: function (sEntityName, oComponent, aFilters) {
			...
			$.get({
                url: `${sEntityName}`+'?$filter=ID eq 1',
		...
		//The Deferred object, introduced in jQuery 1.5, 
		//is a chainable utility object created by calling the jQuery.Deferred() method.
		oCallReadDeferred_v2: function (sEntityName, oComponent, aFilters) {
			var promise = jQuery.Deferred(),
			oDataModel = oComponent.getModel();
			sap.ui.core.BusyIndicator.show(0);
		...
		oCallCreateDeferred: function (sEntityset, oItems, oGroupId, oView) {
			var promise = jQuery.Deferred(),
				oDataModel = oView.getModel();
			sap.ui.core.BusyIndicator.show(0);
