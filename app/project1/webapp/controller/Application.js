sap.ui.define([
	...
	"cap/project1/controller/ErrorHandler",
	"./errorHandling",
	"cap/project1/lib/ManageBusinessLogic"

], function (Object, Device, BindingMode, History, BaseController, ErrorHandler, errorHandling, ManageBusinessLogic) {
	"use strict";

	return Object.extend("cap.project1.controller.Application", {
		...
		init: function () {
			...
			this._oManageBusinessLogic = new ManageBusinessLogic(this);
			...
			this._oGlobalModel = new JSONModel({
				...
				gsswm: this._oManageBusinessLogic,
			...
			//*******************************************************************************************
			// Odata Entity Configuration Model
			//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			this._oMenuTransactionModelNew = new JSONModel(jQuery.sap.getModulePath("cap/project1", "/lib/WMConfiguration.json"));
			...
			this._oProcessControlModel = new JSONModel(jQuery.sap.getModulePath("cap/project1", "/lib/ProcessConfiguration.json"));
