sap.ui.define([
	...
	return Controller.extend("cap.project1.controller.BaseController", {
		...
		seti18nModel: function (oView) {
			...
			var i18nModel = new ResourceModel({
				bundleName: "cap.project1.i18n.i18n"
			});
		...
		destroyModel: function () {
			if (this.getView().getModel(this.getModelName())) {
				...
				this.getView().setModel("", this.getModelName());
			}
		...
		/**
		 * Convenience method to get Export Filterfields property
		 * @public
		 * */
		getExportFilterFields: function () {
			var viewProperties = this.getViewProperties();
			return viewProperties.exportFilters;
		},
		/**
